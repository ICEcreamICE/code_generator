...
import argparse, textwrap#, tkinter

def option_parser():
  options_dict = {}
  #parse argv TODO: make argv to argv_dict next
  parser = argparse.ArgumentParser( prog='CGEN', description='CGEN Digital Flow Start',
                                    formatter_class=argparse.RawDescriptionHelpFormatter,
                                    epilog=textwrap.dedent('''
                                      Examples:
                                        RunTest: CGEN -proj <ProjName> -test <UVMTestCase> -wave
                                        RunLint: CGEN -proj <ProjName> -lint
                                        RunRegr: CGEN -proj <ProjName> -regr <VsifName>
                                        RunAms:  CGEN -proj <ProjName> -test <UVMTestCase> -wave -ams
                                    ''')
                                  )
